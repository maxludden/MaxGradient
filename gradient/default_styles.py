...
GRADIENT_STYLES: Mapping[str, StyleType] = {
    ...
    "style.white": Style(color="#000000", bgcolor="#ffffff", bold=True),
    ...
    "style.lightgrey": Style(color="#000000", bgcolor="#dddddd", bold=True),
    ...
    "style.darkgrey": Style(color="#ffffff", bgcolor="#444444", bold=True),
    "style.darkgray": Style(color="#ffffff", bgcolor="#444444", bold=True),
    "cs.darkgray": Style(color="#444444", bgcolor="#444444", bold=True),
    "style.darkgray": Style(color="#ffffff", bgcolor="#444444", bold=True),
    "black": Style(color="#000000"),
    "bold.black": Style(color="#000000", bold=True),
    "cs.black": Style(color="#000000", bgcolor="#000000", bold=True),
    "style.black": Style(color="#ffffff", bgcolor="#000000", bold=True),
    ...
    "style.lime": Style(color="#000000", bgcolor="#00ff00", bold=True),
    ...
    "style.lightblue": Style(color="#ffffff", bgcolor="#0088ff", bold=True),
    ...
    "purple": Style(color="rgb(95, 0, 255)"),
    ...
    "style.violet": Style(color="#ffffff", bgcolor="#af00ff", bold=True),
...
def get_gradient_style_title() -> Text:
    ...
    """
    letters = [
        Text.from_markup("[bold.magenta]M[/]"),
        Text.from_markup("[bold.lightpurple]a[/]"),
        Text.from_markup("[bold.purple]x[/]"),
        Text.from_markup("[bold.blue]S[/]"),
        Text.from_markup("[bold.lightblue]t[/]"),
        Text.from_markup("[bold.cyan]y[/]"),
        Text.from_markup("[bold.lime]l[/]"),
        Text.from_markup("[bold.yellow]e[/]"),
    ]
...
def styles_table() -> Table:
    ...
    table = Table(
        title=get_gradient_style_title(),
