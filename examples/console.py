...
def console_gradient_rule_thin() -> None:
    ...
    console.line()
    console.gradient_rule("[bold]Thin Gradient Rule[/]", thickness="thin")
    console.line(2)
    console.save_svg(
...
def console_gradient_rule_medium() -> None:
    ...
    console = Console(width=80, record=True)
    console.line()
    console.gradient_rule("[bold]Medium Gradient Rule[/]", thickness="medium")
    console.line(2)
    console.save_svg(
...
def console_gradient_rule_thick() -> None:
    ...
    console = Console(width=80, record=True)
    console.line()
    console.gradient_rule("[bold]Thick Gradient Rule[/]", thickness="thick")
    console.line(2)
    console.save_svg(
