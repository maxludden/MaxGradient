...
class RGB:
    ...
    def __rich_repr__(self) -> Text:
        ...
        log.debug(f"Called RGB.__rich_repr__()")
...
if __name__ == "__main__":
    ...
    console.print(
        f"[white]RGB as Hex:[/] [b {rgb.as_hex}]{rgb.as_hex}[/]"
    
    )
    console.print(
        f"[white]RGB as Tuple:[/]\n      [b {rgb.as_hex}]{rgb.as_tuple}[/]"
    )
