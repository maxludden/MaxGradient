...
class Log:
    rich_level: str
    console: Console
    def __init__(self, console: Optional[Console] = ..., rich_level: str = ...) -> None: ...
    ...
    def log(self, level: str, msg: str | RichRenderable, verbose: bool = ...) -> None: ...
    def opt(self, *kwargs, depth: int = ...) -> Log: ...
    def disable(self) -> None: ...
    def enable(self, module: str = ...) -> None: ...

def watch(*, level: str = ..., depth: int = ..., func_entry: bool = ..., func_exit: bool = ...): ...
