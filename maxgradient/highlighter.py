...
class ColorHighlighter(RegexHighlighter):
    ...
    base_style = "bold."
    highlights = [
        r"(?P<magenta>magenta\b|#[Ff]0[Ff]\b|#[Ff]{2}00[Ff]{2}\b|r?g?b?\(255, ?0, ?255\)\b)",
        r"(?P<violet>violet\b|#a0[Ff]\b|#a[Ff]00[Ff]{2}\b|r?g?b?\(175, ?0, ?255\)\b)",
        r"(?P<purple>purple\b|#50[Ff]\b|#5[Ff]00[Ff]{2}\b|r?g?b?\(95, ?0, ?255\))",
        r"(?P<blue>blue\b|#00[Ff]\b|#0{4}[Ff]{2}\br?g?b?\(0, ?0, ?255\))",
...
if __name__ == "__main__":
    ...
    console.print(f"1. This is a test of the ColorReprHighlighter.", highlight=True)
