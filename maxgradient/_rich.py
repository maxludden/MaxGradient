...
def get_rich_colors() -> Tuple[str, ...]:
    return RICH


@lru_cache(maxsize=203, typed=True)
def get_rich_hex_colors() -> Tuple[str, ...]:
    return RICHHEX


@lru_cache(maxsize=203, typed=True)
def get_rich_rgb_colors() -> Tuple[str, ...]:
    return RICHRGB
...
def get_rich_color(color: str) -> Optional[str]:
    ...
    if color in get_rich_colors():
        ...
        rgb = get_rich_rgb_colors()[index]
        return rgb
    elif color in get_rich_hex_colors():
        index = get_rich_hex_colors().index(color)
        rgb = get_rich_rgb_colors()[index]
        return rgb
    elif color in get_rich_rgb_colors():
        return color
    else:
        return None
...
def get_title() -> Text:
    ...
    x11 = Text("Rich ", style=Style(color="#ff00ff", bold=True))
...
def demo(save: bool) -> None:
    ...
    console.save_svg("rich_colors.svg")
