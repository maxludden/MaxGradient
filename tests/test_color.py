...
- The Color class represents a color and provides various methods and properties to manipulate and retrieve information about the color.
- It can be initialized with a color value in different formats such as hex, RGB, or color names.
- The class supports conversion between different color formats and provides properties to access the color values in different formats such as hex, RGB, and RGB tuple.
- It also provides methods to lighten or darken the color, calculate contrast with other colors, and generate a color table.
