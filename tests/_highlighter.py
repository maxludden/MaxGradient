"""Tests that the ColorHighlighter applies style to color names and hex codes"""
import unittest
...
class TestColorHighlighter(unittest.TestCase):
    ...
    # Tests that the ColorHighlighter applies style to RGB values
    ...
    # Tests that the ColorHighlighter applies style to HTML tags
    ...
    # Tests that the ColorHighlighter applies style to attribute names and values
    ...
    # Tests that the ColorHighlighter applies style to braces and ellipsis
    ...
    # Tests that the ColorHighlighter applies style to IPv4, IPv6, EUI-48, EUI-64, and UUID
